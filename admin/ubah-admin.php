...
$id = $_GET["id"];
$admin = getData("SELECT * FROM admin WHERE id = '$id'")[0];
?>
    ...
    <div class="row justify-content-center g-5 mt-2">
        <div class="col-md-9">
            <?php if (isset($_POST["ubah-profil"])) {
                $_POST["email"] = $_SESSION["adminMasuk"];
                if (ubahProfil($_POST, 'admin') > 0) {
                    echo
            ...
            <form method="post">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input class="form-control" name="firstname" id="firstname" value="<?= $admin['nama_depan'] ?>">
                    </div>
                    <div class="col-md-6">
                ...
                <div class="mt-3">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="gender" value="Laki-laki"
                               id="male" <?php if ($admin['jenis_kelamin'] == 'Laki-laki') echo 'checked' ?>
                               required>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="gender" value="Perempuan"
                               id="female" <?php if ($admin['jenis_kelamin'] == 'Perempuan') echo 'checked' ?>
                               required>
